...
export default function Storia({ version }) {
    ...
    return (
        <section>
            ...
            <div style={{ marginLeft: 'auto', marginRight: 'auto', maxWidth: '1380px', width: '100%' }}>
                <div style={{ fontFamily: 'var(--bmd-font-Secondary)', fontSize: '16px', fontWeight: 400, letterSpacing: 0, lineHeight: '1.5rem', maxWidth: '400px', paddingBottom: '32px', padding: '6rem 16px 2rem' }}>

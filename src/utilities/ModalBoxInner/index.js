...
const ModalBoxInner = ({ isOpen, content, ModalHandler }) => {
    return (
        <section>
            {isOpen === true && (
                <div classNameName={styles.holder}>
                    {isOpen && (<div classNameName={styles.exitButton} onClick={ModalHandler}>
                    ...
                    <div style={{ margin: '0 30px' }}>
                        <div classNameName={styles.grid}>
                            ...
                            <div>
                                <div classNameName={styles.per}>
                                    <p>$50.38 <span classNameName={styles.strike}>$62.98</span></p>
                                    <p classNameName={styles.ft12}>SAVE $12.60 WITH SUBSCRIBE & SAVE</p>
                                </div>
                            </div>
                            <div>
                                <div classNameName={styles.per}>
                                    <p>$50.38 <span classNameName={styles.strike}>$62.98</span></p>
                                    <p classNameName={styles.ft12}>EXCLUSIVE OFFER. SAVE 30% ($18.89)</p>
                                </div>
                            </div>
                            <div classNameName={styles.box5}><img width="150" height="150" src="https://f.shgcdn.com/ab21f754-d400-4d8f-80cf-198be3329f90/" className="styles_imageSource__xZJZ_" /></div>
                            <div classNameName={styles.boxDetails}>
                            ...
                            <div classNameName={styles.boxDetails}><p>SAVINGS APPLIED AT CHECKOUT. ONE-TIME PURCHASE ONLY, LIMIT TWO PER HOUSEHOLD</p>

                            </div>
                            <div classNameName={styles.box6}>
                                <label className="styles_label__sD0A9">Delivery every:</label>
                                <select className="styles_select__xqdkO"><option value="30">30 days</option><option value="60">60 days</option><option value="90">90 days</option></select>
                            </div>
